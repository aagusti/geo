...
setup(name='opensipkd-sig',
      version='0.0',
      description='opensipkd-sig',
      ...
      test_suite="opensipkdsig",
      entry_points = """\
      [paste.app_factory]
      main = opensipkdsig:main
      [console_scripts]
      initialize_opensipkdsig_db = opensipkdsig.scripts.initializedb:main      
      """,
      )
